...
export default function AgentsPage() {
  const { agents, fetchAgents, addAgent } = useAppStore();
    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {agents.map((agent: any) => (
          <div key={agent.id} className="p-6 rounded-2xl glass-card border border-slate-800 hover:border-blue-500/40 space-y-4 flex flex-col justify-between">
            <div>
