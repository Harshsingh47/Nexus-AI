...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-dark-950 text-white -ml-64 relative overflow-hidden flex flex-col justify-between">
      ...
      {/* Landing Footer */}
      <footer className="border-t border-slate-800/80 py-8 px-6 bg-slate-950/80">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-400 font-mono">
          <div className="flex items-center gap-2">
            ...
            <span>NexusMind AI Platform © 2026</span>
          </div>
          <div className="flex items-center gap-6">
            <Link href="/dashboard" className="hover:text-white transition-colors">Command Center</Link>
            <Link href="/builder" className="hover:text-white transition-colors">Flow Builder</Link>
            <Link href="/vibe-builder" className="hover:text-white transition-colors">Vibe Studio</Link>
